...
func GetAllUsers(w http.ResponseWriter, r *http.Request) {
	...
	selectAllUsers := "SELECT users.first_name, users.last_name, users.user_name, users.isdeleted, role.role_name FROM users JOIN users_role ON users.uid = users_role.uid JOIN role ON role.rid = users_role.rid where cid=$1;"
