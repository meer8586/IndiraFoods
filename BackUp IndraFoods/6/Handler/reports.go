...
func GetReport(w http.ResponseWriter, r *http.Request) {
	...
	if isValidToken {
		...
		selectReports := "SELECT repid, rep_name, rep_desc, location, cid, created_at, daily_runtime from report where cid = $1 and rep_name=$2 order by created_at desc;"
...
func DownloadReport(w http.ResponseWriter, r *http.Request) {
	...
	if isValidToken {
		...
		selectReport := "SELECT rep_name, location, cid FROM REPORT WHERE repid=$1 and cid=$2; "
