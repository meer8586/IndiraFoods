...
func WebService() {
	...
	myRouter.HandleFunc("/getreports/{cid}", h.GetAllReports).Methods("GET")
	myRouter.HandleFunc("/getreport/{cid}/{repname}", h.GetReport).Methods("GET")
	myRouter.HandleFunc("/addreport", h.AddReport).Methods("POST")
	myRouter.HandleFunc("/savereport/{cid}", h.StoreReport).Methods("POST")
	myRouter.HandleFunc("/downloadreport", h.DownloadReport).Methods("POST")

	myRouter.HandleFunc("/getrepemailconfig/{cid}", h.GetReportEmailConfig).Methods("GET")
